...
# 准备初始容器
[ ! -f $OS_PATH/base.aci ] && docker2aci docker://archlinux/base && mv ./archlinux-base-latest.aci $OS_PATH/base.aci && chown $APP_USER:$APP_GROUP $OS_PATH/base.aci
...
# 更新系统
acbuild ${ACBUILD_ARGS_DEBUG} run -- sed -i '1s/^/Server = https:\/\/mirrors.huaweicloud.com\/archlinux\/$repo\/os\/$arch\n/' /etc/pacman.d/mirrorlist
acbuild ${ACBUILD_ARGS_DEBUG} run -- pacman --noconfirm -Syu
