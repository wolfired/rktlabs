...
# 安装运行依赖
acbuild --debug run -- apk --no-cache add bind-tools ca-certificates curl fcgi ffmpeg geoip gzip logrotate mediainfo nginx php7 php7-cgi php7-fpm php7-json  php7-mbstring php7-pear rtorrent screen sox tar unrar unzip wget zip
